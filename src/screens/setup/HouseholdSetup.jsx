...
export default function HouseholdSetup() {
  ...
  const joinHousehold = async () => {
    ...
    try {
      ...
      // Firestore rules only let this write through if a household with this id
      // actually exists — so a bad code fails right here instead of leaving behind
      // a half-joined adults doc pointing at nothing.
      await setDoc(doc(db, 'adults', user.uid), {
        householdId: code,
        email: user.email,
        name: yourName.trim(),
